...
*/		
		...
		uint8_t is_decoded_2_ = read_uint8("is_decoded_2") ; 
		
		uint8_t is_decoded = (is_decoded_1 && is_decoded_2_) ;
	...
	write_uint8("Iterations_required",(nitr_1-1));
...
*/			
		uint8_t _is_decoded_2 = checkIsdecoded2( ) ;
		
		write_uint8("is_decoded_2",_is_decoded_2) ;
