...
vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir/minSumDecode_partitioned_OneCodeBlock/ahir_system.vhdl

vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir/minSumDecode_partitioned_OneCodeBlock/ahir_system_test_bench.vhdl
