...
vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir/floatingPointAdder/ahir_system_global_package.vhdl
# anurag_modified_end

vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir/floatingPointAdder/ahir_system.vhdl

vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir/floatingPointAdder/ahir_system_test_bench.vhdl
