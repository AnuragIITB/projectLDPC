...
vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir1/minSumDecode_partitioned_Example_UsingAa/ahir_system_global_package.vhdl
# anurag_modified_end

vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir1/minSumDecode_partitioned_Example_UsingAa/ahir_system.vhdl

vlib work
vmap work work
vcom -work work /home/anurag/LDPC/projectLDPC/ahir1/minSumDecode_partitioned_Example_UsingAa/ahir_system_test_bench.vhdl
